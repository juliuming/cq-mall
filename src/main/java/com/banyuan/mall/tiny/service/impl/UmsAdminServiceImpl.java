...
import com.banyuan.mall.tiny.common.utils.JwtTokenUtil;
import com.banyuan.mall.tiny.mbg.mapper.UmsAdminMapper;
...
public class UmsAdminServiceImpl implements UmsAdminService {
    ...
    @Override
    public UmsAdmin getUmsAdminByName(String name) {
        return umsAdminMapper.selectByUserName(name);
    }

    @Override
    public List<UmsPermission> getPermissionList(Long id){
        return umsAdminMapper.selectPermissionListById(id);
    }
}
